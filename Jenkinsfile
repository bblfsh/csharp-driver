pipeline {
  agent {
    kubernetes {
      label 'csharp-driver-bblfsh-performance'
      defaultContainer 'csharp-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: csharp-driver-bblfsh-performance
...
"""
  ...
  environment {
    DRIVER_LANGUAGE = "csharp"
    DRIVER_REPO = "https://github.com/bblfsh/csharp-driver.git"
